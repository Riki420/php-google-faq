...
$faqs = [
    ...
    [
        ...
        'paragraph' => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.<br><br>
                            ...
                            Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, <a href='#' class='my-link'>nel Centro Google per la sicurezza online.</a><br><br>
                            <a href='#' class='my-link'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo."
    ...
    [
        ...
        'paragraph' => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:<br><br>
                            ...
                            <h2 class='my-2'>Stabilire il paese associato al tuo account</h2>
    ...
    [
        ...
        'paragraph' => "I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, devi <a href='#' class='my-link'>contattare il webmaster</a> del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, fai clic qui. Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In caso di una richiesta di rimozione urgente, è inoltre possibile <a href='#' class='my-link'>visitare la nostra pagina di assistenza</a> per avere ulteriori informazioni."

    ],
    [
        'title' => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
        'paragraph' => "In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione anche l'indirizzo Internet, o URL, della pagina dei risultati di ricerca sotto forma di <a href='#' class='my-link'>URL referrer.</a> Talvolta, l'URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito. Se utilizzi la ricerca SSL (la funzione di ricerca criptata di Google), nella maggior parte dei casi i termini di ricerca non vengono inviati come parte dell'URL negli URL referrer. Questo comportamento può fare eccezione, ad esempio se utilizzi alcuni browser meno diffusi. Ulteriori informazioni sulla ricerca SSL sono disponibili <a href='#' class='my-link'>qui</a>. Le query di ricerca o le informazioni contenute nell'URL referrer potrebbero essere disponibili mediante Google Analytics o un'API (Application Programming Interface). Inoltre, gli inserzionisti potrebbero ricevere informazioni relative all' esatte parole chiave che hanno determinato il clic su un annuncio."
    ]
]
...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta2/css/all.min.css" rel="stylesheet" integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous">
...
<body>
    <!--Header-->
    <div class="position-fixed bg-white w-100">
        <!--Header Top-->
        <header class="py-1">
            <div class="container-fluid d-flex flex-wrap justify-content-between">
                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                    <a href="/" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/1920px-Google_2015_logo.svg.png" alt="google.logo" class="img-fluid logo me-2">
                        <span class="fs-4 text-muted">Privacy e termini</span>
                    </a>
                </div>
                <div class="col-12 col-lg-auto mb-3 mb-lg-0">
        ...
        <!--Navbar-->
        <nav class="py-1 border-bottom">
            <div class="container-fluid d-flex flex-wrap">
                <ul class="nav me-auto">
                    <li class="nav-item"><a href="#" class="nav-link link-dark px-2 active" aria-current="page">Introduzione</a></li>
                    <li class="nav-item"><a href="#" class="nav-link link-dark px-2">Norme sulla privacy</a></li>
                    <li class="nav-item"><a href="#" class="nav-link link-dark px-2">Termini di condizione</a></li>
                    <li class="nav-item"><a href="#" class="nav-link link-dark px-2">Tecnologie</a></li>
                    <li class="nav-item"><a href="#" class="nav-link link-dark px-2">Domande frequenti</a></li>
                </ul>
            </div>
        </nav>
    </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="container w-75">
                        <div class="row">
                            <div class="col">
                                <!--Ciclo sull'array FAQS per ogni faq dentro di esso-->
                        ...
                        <div class="row justify-content-between">
                            <div class="col-4">
                                <ul class="li-style-none">
                                    <li class="li-inline"><a href="#">Google</a></li>
                                    <li class="li-inline"><i class="fas fa-circle"></i></li>
                                    <li class="li-inline"><a href="#">About Google</a></li>
                                    <li class="li-inline"><i class="fas fa-circle"></i></li>
                                    <li class="li-inline"><a href="#">Privacy</a></li>
                                    <li class="li-inline"><i class="fas fa-circle"></i></li>
                                    <li class="li-inline"><a href="#">Terms</a></li>
                                </ul>
                            </div>
                            <div class="col-4">
